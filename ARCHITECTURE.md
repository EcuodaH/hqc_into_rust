...
Pour plus d'information sur le temps constant dans HQC voir la section concernée dans le [TEMPS_CONSTANT.md](https://github.com/EcuodaH/hqc_into_rust/blob/main/TEMPS_CONSTANT.md)
